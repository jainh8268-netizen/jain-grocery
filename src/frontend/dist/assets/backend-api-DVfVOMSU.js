...
const LoginResult = Variant({ "ok": Text, "err": Text });
const ProductId = Nat;
...
Service({
  ...
  "adminLogin": Func([Text, Text], [LoginResult], []),
  "fixProductImages": Func([Text, Vec(ProductId)], [], []),
  "getActiveProducts": Func([], [Vec(Product)], ["query"]),
  "getAllOrders": Func([Text], [Vec(Order)], ["query"]),
  "getAllProducts": Func([Text], [Vec(Product)], ["query"]),
  "getProductAverageRating": Func(
    [Nat],
    [Opt(Float64)],
    ["query"]
  ),
  "getProductRatings": Func([Nat], [Vec(RatingEntry)], ["query"]),
  "markOrderCompleted": Func([Text, OrderId], [Opt(Order)], []),
  "markOrderRead": Func([Text, OrderId], [Opt(Order)], []),
  "placeOrder": Func([OrderInput], [Order], []),
  "rateProduct": Func([Nat, Nat, Text], [], []),
  "toggleProduct": Func([Text, ProductId], [Opt(Product)], []),
  "updateProductImage": Func(
    [Text, ProductId, Text],
    [Opt(Product)],
    []
  )
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const LoginResult2 = IDL2.Variant({ "ok": IDL2.Text, "err": IDL2.Text });
  ...
  const RatingEntry2 = IDL2.Record({
    "createdAt": IDL2.Int,
    "productId": IDL2.Nat,
    "comment": IDL2.Text,
    "rating": IDL2.Nat
  ...
  return IDL2.Service({
    ...
    "adminLogin": IDL2.Func([IDL2.Text, IDL2.Text], [LoginResult2], []),
    "fixProductImages": IDL2.Func([IDL2.Text, IDL2.Vec(ProductId2)], [], []),
    "getActiveProducts": IDL2.Func([], [IDL2.Vec(Product2)], ["query"]),
    "getAllOrders": IDL2.Func([IDL2.Text], [IDL2.Vec(Order2)], ["query"]),
    "getAllProducts": IDL2.Func([IDL2.Text], [IDL2.Vec(Product2)], ["query"]),
    "getProductAverageRating": IDL2.Func(
      [IDL2.Nat],
      [IDL2.Opt(IDL2.Float64)],
      ["query"]
    ),
    "getProductRatings": IDL2.Func(
      [IDL2.Nat],
      [IDL2.Vec(RatingEntry2)],
      ["query"]
    ),
    "markOrderCompleted": IDL2.Func([IDL2.Text, OrderId2], [IDL2.Opt(Order2)], []),
    "markOrderRead": IDL2.Func([IDL2.Text, OrderId2], [IDL2.Opt(Order2)], []),
    "placeOrder": IDL2.Func([OrderInput2], [Order2], []),
    "rateProduct": IDL2.Func([IDL2.Nat, IDL2.Nat, IDL2.Text], [], []),
    "toggleProduct": IDL2.Func([IDL2.Text, ProductId2], [IDL2.Opt(Product2)], []),
    "updateProductImage": IDL2.Func(
      [IDL2.Text, ProductId2, IDL2.Text],
      [IDL2.Opt(Product2)],
      []
    )
  });
...
class Backend {
  ...
  async addProduct(arg0, arg1, arg2, arg3) {
  ...
  async fixProductImages(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getProductAverageRating(arg0) {
    if (this.processError) {
      try {
  ...
  async markOrderCompleted(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async rateProduct(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async updateProductImage(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
function from_candid_LoginResult_n1(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n7(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "read" in value ? "read" : "completed" in value ? "completed" : value;
}
...
const uploadFnRef = { current: null };
const downloadFnRef = { current: null };
...
function useAllProducts(token) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
    queryKey: ["allProducts", token],
    queryFn: async () => {
      if (!actor || !token) return [];
      return actor.getAllProducts(token);
    },
    enabled: !!actor && !isFetching && !!token
  });
}
function useAllOrders(token) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
function useMarkOrderRead(token) {
  const { actor } = useBackendActor();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (orderId) => {
      if (!actor || !token) throw new Error("Not authenticated");
      return actor.markOrderRead(token, orderId);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["orders"] });
    }
...
function useMarkOrderCompleted(token) {
  const { actor } = useBackendActor();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (orderId) => {
      if (!actor || !token) throw new Error("Not authenticated");
      return actor.markOrderCompleted(token, orderId);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["orders"] });
    }
...
function useToggleProduct(token) {
  const { actor } = useBackendActor();
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (productId) => {
      if (!actor || !token) throw new Error("Not authenticated");
      return actor.toggleProduct(token, productId);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["allProducts"] });
      queryClient.invalidateQueries({ queryKey: ["activeProducts"] });
...
function useFixProductImages(_token) {
  return useMutation({
    mutationFn: async () => {
    }
  });
}
function useProductAverageRating(productId) {
  const { actor, isFetching } = useBackendActor();
  return useQuery({
...
async function waitForStorageFns(maxWaitMs = 5e3) {
...
export {
  OrderStatus as O,
  useProductAverageRating as a,
  useRateProduct as b,
  usePlaceOrder as c,
  useAdminLogin as d,
  useAllOrders as e,
  useMarkOrderRead as f,
  useMarkOrderCompleted as g,
  useAllProducts as h,
  useAddProduct as i,
  useFixProductImages as j,
  useUploadImage as k,
  useToggleProduct as l,
  useActiveProducts as u
};
